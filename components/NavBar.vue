    ...
    <div class="w-auto">
        <nav class="md:grid grid-cols-2 md:items-center md:justify-items-center 2xl:grid-cols-8 2xl:gap-2">
            ...
            <div class="2xl:col-span-1">
                ...
                <button @click="setLocale('fr')" class="dark:text-white text-2xl px-4"><img src="assets/images/flagFR.webp" alt="drapeau français" 
                    class="w-7 border-2 border-sky-700 dark:border-orange-400"/>
                </button>
                <button @click="setLocale('en')" class="dark:text-white text-2xl px-4"><img src="assets/images/flagEN.webp" alt="drapeau anglais" 
                    class="w-7 border-2 border-sky-700 dark:border-orange-400" />
                </button>
                <button @click="setLocale('ja')" class="dark:text-white text-2xl px-4"><img src="assets/images/flagJA.webp" alt="drapeau japonais" 
                    class="w-7 border-2 border-sky-700 dark:border-orange-400"/>
                </button>
                </div>
            </div>
