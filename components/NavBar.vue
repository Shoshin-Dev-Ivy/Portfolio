<template>
    <div class="w-auto md:w-full">
        <nav class="flex-col md:grid grid-cols-4 md:items-center md:justify-items-center md:gap-2 md:w-auto">
            ...
            <div class ="">
                <button @click = "toggleMenu"  value = "hamburger"  class ="flex flex-col justify-around justify-self-center h-8 w-8 p-1 mt-6 ml-2 rounded md:hidden "> 
                ...
                <a class="flex justify-center text-orange-400 font-black dark:text-white text-2xl h hover:underline hover:underline-offset-8 py-2" 
